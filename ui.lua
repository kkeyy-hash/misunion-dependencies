...
do
    ...
    function library:Loader(info)
        ...
        function window:CloseContent()
            if window.currentContent.dropdown and window.currentContent.dropdown.open then
                ...
                utility:LoadImage(dropdown.dropdown_image, "arrow_down", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/arrow_down.png?raw=true")
                --
            ...
            elseif window.currentContent.multibox and window.currentContent.multibox.open then
                ...
                utility:LoadImage(multibox.multibox_image, "arrow_down", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/arrow_down.png?raw=true")
                --
    ...
    function pages:PlayerList(info)
        ...
        for Index = 1, 1 do
            ...
            --
            utility:LoadImage(button_image, "arrow_down", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/arrow_down.png?raw=true")
            --
            ...
            function button:Open()
                window:CloseContent()
                button.open = not button.open
                utility:LoadImage(button_image, "arrow_up", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/arrow_up.png?raw=true")
                --
            ...
            --
            utility:LoadImage(button_gradient, "gradient", "hhttps://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")
            --
            library.began[#library.began + 1] = function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 and (button_outline.Visible or button.open) and window.isVisible then
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and button_outline.Visible then
                        ...
                        elseif utility:MouseOverDrawing({button_outline.Position.X, button_outline.Position.Y, button_outline.Position.X + button_outline.Size.X, button_outline.Position.Y + button_outline.Size.Y}) and not window:IsOverContent() then
                            task.spawn(function()
                                utility:LoadImage(button_gradient, "gradientdown", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/gradientdown.png?raw=true") 
                                --
                                task.wait(0.15)
                                --
                                utility:LoadImage(button_gradient, "gradient", "hhttps://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true") 
        ...
        --
        utility:LoadImage(list_gradient, "gradient", "hhttps://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")
        --
    ...
    function sections:Toggle(info)
        ...
        --
        utility:LoadImage(toggle__gradient, "gradient", "hhttps://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")
        --
        function toggle:Get()
        ...
        function toggle:Colorpicker(info)
            ...
            --
            if transp then
                utility:LoadImage(colorpicker__transparency, "cptransp", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/cptransp.png?raw=true")
            end
            utility:LoadImage(colorpicker__gradient, "gradient", "hhttps://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")
            --
                    ...
                    elseif utility:MouseOverDrawing({section.section_frame.Position.X + (section.section_frame.Size.X - (colorpicker.index == 0 and (30 + 4 + 2) or (64 + 4 + 2))), section.section_frame.Position.Y + colorpicker.axis, section.section_frame.Position.X + section.section_frame.Size.X - (colorpicker.index == 1 and 36 or 0), section.section_frame.Position.Y + colorpicker.axis + 15}) and not window:IsOverContent() then
                        if not colorpicker.open then
                            ...
                            if transp then
                                ...
                                --
                                utility:LoadImage(colorpicker_open_transparency_image, "transp", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/transp.png?raw=true")
                            ...
                            --
                            utility:LoadImage(colorpicker_open_picker_image, "valsat", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/valsat.png?raw=true")
                            utility:LoadImage(colorpicker_open_picker_cursor, "valsat_cursor", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/valsat_cursor.png?raw=true")
                            utility:LoadImage(colorpicker_open_huepicker_image, "hue", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/hue.png?raw=true")
                            --
        ...
        function toggle:Keybind(info)
            ...
            --
            utility:LoadImage(keybind__gradient, "gradient", "hhttps://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")
            --
    ...
    function sections:Slider(info)
        ...
        --
        utility:LoadImage(slider__gradient, "gradient", "hhttps://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")
        --
    ...
    function sections:TextBox(info)
        ...
        --
        utility:LoadImage(textbox_gradient, "gradient", "hhttps://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")
        --
        ...
        library.began[#library.began + 1] = function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 and textbox_outline.Visible and window.isVisible then
                if reactive and utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + textbox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + textbox.axis + 20}) and not window:IsOverContent() then
                    task.spawn(function()
                        utility:LoadImage(textbox_gradient, "gradientdown", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/gradientdown.png?raw=true") 
                        --
                        task.wait(0.15)
                        --
                        utility:LoadImage(textbox_gradient, "gradient", "hhttps://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true") 
    ...
    function sections:Dropdown(info)
        ...
        --
        utility:LoadImage(dropdown_image, "arrow_down", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/arrow_down.png?raw=true")
        utility:LoadImage(dropdown__gradient, "gradient", "hhttps://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")
        --
        if max then
        ...
        library.began[#library.began + 1] = function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and dropdown_outline.Visible then
                ...
                elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + dropdown.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + dropdown.axis + (name and (15 + 20) or (20))}) and not window:IsOverContent() then
                    task.spawn(function()
                        utility:LoadImage(dropdown__gradient, "gradientdown", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/gradientdown.png?raw=true") 
                        --
                        task.wait(0.15)
                        --
                        utility:LoadImage(dropdown__gradient, "gradient", "hhttps://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true") 
                    ...
                    if not dropdown.open then
                        window:CloseContent()
                        dropdown.open = not dropdown.open
                        utility:LoadImage(dropdown_image, "arrow_up", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/arrow_up.png?raw=true")
                        --
    ...
    function sections:Multibox(info)
        ...
        --
        utility:LoadImage(multibox_image, "arrow_down", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/arrow_down.png?raw=true")
        utility:LoadImage(multibox__gradient, "gradient", "hhttps://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")
        --
        ...
        library.began[#library.began + 1] = function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 and window.isVisible and multibox_outline.Visible then
                ...
                elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + multibox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + multibox.axis + (name and 15 or 0) + 20}) and not window:IsOverContent() then
                    task.spawn(function()
                        utility:LoadImage(multibox__gradient, "gradientdown", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/gradientdown.png?raw=true") 
                        --
                        task.wait(0.15)
                        --
                        utility:LoadImage(multibox__gradient, "gradient", "hhttps://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true") 
                    ...
                    if not multibox.open then
                        window:CloseContent()
                        multibox.open = not multibox.open
                        utility:LoadImage(multibox_image, "arrow_up", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/arrow_up.png?raw=true")
                        --
                        ...
                        for i,v in pairs(multibox.options) do
                            ...
                            --
                            utility:LoadImage(multibox_value_gradient, "gradient", "hhttps://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")]]
                            --

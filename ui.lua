...
do
    ...
    function pages:PlayerList(info)
        ...
        for Index = 1, 1 do
            ...
            --
            utility:LoadImage(button_gradient, "gradient", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")
            --
            library.began[#library.began + 1] = function(Input)
        ...
        --
        utility:LoadImage(list_gradient, "gradient", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")
        --
    ...
    function sections:Toggle(info)
        ...
        --
        utility:LoadImage(toggle__gradient, "gradient", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")
        --
        function toggle:Get()
        ...
        function toggle:Colorpicker(info)
            ...
            utility:LoadImage(colorpicker__gradient, "gradient", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")
            --
        ...
        function toggle:Keybind(info)
            ...
            --
            utility:LoadImage(keybind__gradient, "gradient", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")
            --
    ...
    function sections:Slider(info)
        ...
        --
        utility:LoadImage(slider__gradient, "gradient", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")
        --
    ...
    function sections:TextBox(info)
        ...
        --
        utility:LoadImage(textbox_gradient, "gradient", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")
        --
    ...
    function sections:Dropdown(info)
        ...
        utility:LoadImage(dropdown__gradient, "gradient", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")
        --
        if max then
    ...
    function sections:Multibox(info)
        ...
        utility:LoadImage(multibox__gradient, "gradient", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")
        --
                ...
                elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + multibox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + multibox.axis + (name and 15 or 0) + 20}) and not window:IsOverContent() then
                    ...
                    if not multibox.open then
                        ...
                        for i,v in pairs(multibox.options) do
                            ...
                            --
                            utility:LoadImage(multibox_value_gradient, "gradient", "https://github.com/kkeyy-hash/nordhook/blob/main/assets/gradient.png?raw=true")]]
                            --
